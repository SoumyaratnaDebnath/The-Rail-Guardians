...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var vertices = [
        {x: 100, y: 150, color: "black", neighbors: [1, 7, 8], energy : 0}, //0
        {x: 250, y: 150, color: "black", neighbors: [0, 7, 8], energy : 0}, //1
        {x: 400, y: 150, color: "black", neighbors: [9, 3], energy : 0}, //2
        {x: 550, y: 150, color: "black", neighbors: [2, 10, 11, 4], energy : 0}, //3
        {x: 700, y: 150, color: "black", neighbors: [3, 5], energy : 0}, //4
        {x: 850, y: 150, color: "black", neighbors: [4, 11, 13], energy : 0}, //5
        {x: 1000, y: 150, color: "black", neighbors: [], energy : 0}, //6

        {x: 100, y: 350, color: "black", neighbors: [0, 1, 8], energy : 0}, //7
        {x: 250, y: 350, color: "black", neighbors: [7, 0, 1], energy : 0}, //8
        {x: 400, y: 350, color: "black", neighbors: [1, 2], energy : 0}, //9
        {x: 550, y: 350, color: "black", neighbors: [3, 11], energy : 0}, //10
        {x: 700, y: 350, color: "black", neighbors: [10, 3, 5], energy : 0}, //11
        {x: 850, y: 350, color: "black", neighbors: [], energy : 0}, //12
        {x: 1000, y: 350, color: "black", neighbors: [5], energy : 0}, //13
    ];

    // var edges = [
    //     {from: 0, to: 1, color: "black"},
    //     {from: 0, to: 2, color: "black"},
    //     {from: 0, to: 3, color: "black"},
