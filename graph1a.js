...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var vertices = [
        {x: 500, y: 100, color: "black", neighbors: [1, 5]},   // 0
        {x: 650, y: 175, color: "black", neighbors: [0, 2]},   // 1
        {x: 650, y: 325, color: "black", neighbors: [1, 3]},   // 2
        {x: 500, y: 400, color: "black", neighbors: [2, 4]},   // 3
        {x: 350, y: 325, color: "black", neighbors: [3, 5]},   // 4
        {x: 350, y: 175, color: "black", neighbors: [4, 0]},   // 5
    ];
