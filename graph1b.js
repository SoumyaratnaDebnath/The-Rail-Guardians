...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var vertices = [
        {x: 100, y: 150, color: "black", neighbors: [1, 7, 8]}, //0
        {x: 250, y: 150, color: "black", neighbors: [0, 7, 8]}, //1
        {x: 400, y: 150, color: "black", neighbors: [9, 3]}, //2
        {x: 550, y: 150, color: "black", neighbors: [2, 10, 11, 4]}, //3
        {x: 700, y: 150, color: "black", neighbors: [3, 5]}, //4
        {x: 850, y: 150, color: "black", neighbors: [4, 11, 13]}, //5
        {x: 1000, y: 150, color: "black", neighbors: []}, //6

        {x: 100, y: 350, color: "black", neighbors: [0, 1, 8]}, //7
        {x: 250, y: 350, color: "black", neighbors: [7, 0, 1]}, //8
        {x: 400, y: 350, color: "black", neighbors: [1, 2]}, //9
        {x: 550, y: 350, color: "black", neighbors: [3, 11]}, //10
        {x: 700, y: 350, color: "black", neighbors: [10, 3, 5]}, //11
        {x: 850, y: 350, color: "black", neighbors: []}, //12
        {x: 1000, y: 350, color: "black", neighbors: [5]}, //13
    ];
